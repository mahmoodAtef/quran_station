...
class StartQuizScreen extends StatelessWidget {
        ...
        return Screenshot(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              actions: [
                if (cubit.state is! GetQuizLoadingState && cubit.qestions.isNotEmpty)
                  IconButton(
                      tooltip: "مشاركة السؤال",
                      onPressed: () async {
                        await _captureAndShareScreenshot(
                            context, screenshotController, "اختبر معلوماتك في القران الكريم..!");
                      },
                      icon: const Icon(
                        Icons.share,
                        color: ColorManager.black,
                          ...
                          child: Column(
                            children: [
                              Padding(
                                ...
                                child: ProgressBar(currentQuestion: cubit.currentpage + 1),
                              ),
                              Expanded(
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    IconButton(
                                        onPressed: () {
                                          if (cubit.currentpage != 0) {
                                            cubit.changeQuestionPage(cubit.currentpage - 1);
                                          }
                                        },
                                        icon: Icon(
                                    ...
                                    if (cubit.currentpage == 19 && !cubit.quizCompleted)
                                      Expanded(
                                        child: SizedBox(
                                          height: 5.h,
                                          child: ElevatedButton(
                                              onPressed: () {
                                                ...
                                                showDialog(
                                                    ...
                                                    builder: (context) {
                                                      return Screenshot(
                                                        controller: resultScreenshotController,
                                                        child: AlertDialog(
                                                          elevation: 3,
                                                          actions: [
                                                            TextButton(
                                                              child: const Text("تحدي الأصدقاء"),
                                                              onPressed: () async {
                                                                await _captureAndShareScreenshot(
                                                                    context,
                                                            ...
                                                            TextButton(
                                                                ...
                                                                child:
                                                                    const Text("مراجعة الاجابات"))
                                                          ],
                                                          content: Column(
                                                            mainAxisSize: MainAxisSize.min,
                                                            children: [
                                                              if (cubit.totalMarks > 10)
                                                                const Text('تهانينا'),
                                                              const Text('لقد حصلت على '),
                                                                  ...
                                                                  SizedBox(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      value: cubit.totalMarks /
                                                                          20, // تحويل نسبة الدرجة إلى النسبة المطلوبة
                                                                      strokeWidth: 10,
                                                                      valueColor:
  ...
  Future<void> _captureAndShareScreenshot(
      BuildContext context, ScreenshotController screenshotController, String text) async {
