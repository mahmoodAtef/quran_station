  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AudiosBloc, AudiosState>(
      ...
      builder: (context, state) {
        return ConnectionWidget(child: Column(
          children: [
             state is GetMostPopularRecitersLoadingState ? ? const LinearProgressIndicator() : const SizedBox(),
          bloc.mostPopularReciters.isEmpty ? const SizedBox() :    Expanded(child: RecitersList(reciters: bloc.mostPopularReciters)),
          ],
        ));
      },
    );
